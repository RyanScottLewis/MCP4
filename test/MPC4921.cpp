...
TEST_CASE("MCP4::write(config, value)", "[func]") {
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_X1, 0xABCD) == (uint16_t)0x7BCD);
  REQUIRE(dac.write(MCP4::BUFFERED_X2, 0xABCD) == (uint16_t)0x5BCD);
}
...
TEST_CASE("MCP4::write(config, valueUpper, valueLower)", "[func]") {
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_X1, 0xAB, 0xCD) == (uint16_t)0x7BCD);
  REQUIRE(dac.write(MCP4::BUFFERED_X2, 0xAB, 0xCD) == (uint16_t)0x5BCD);
}
