...
TEST_CASE("MCP4::write(config, value)", "[func]") {
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_A_X1, 0xABCD) == (uint16_t)0x7F34);
  REQUIRE(dac.write(MCP4::BUFFERED_A_X2, 0xABCD) == (uint16_t)0x5F34);
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_B_X1, 0xABCD) == (uint16_t)0xFF34);
  REQUIRE(dac.write(MCP4::BUFFERED_B_X2, 0xABCD) == (uint16_t)0xDF34);
}
...
TEST_CASE("MCP4::write(config, value, *command)", "[func]") {
  ...
  REQUIRE(command == (uint16_t)0xFF34);

  dac.write(MCP4::BUFFERED_B_X2, 0xABCD, command);
  REQUIRE(command == (uint16_t)0xDF34);
}
...
TEST_CASE("MCP4::write(config, valueUpper, valueLower)", "[func]") {
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_A_X1, 0xAB, 0xCD) == (uint16_t)0x7F34);
  REQUIRE(dac.write(MCP4::BUFFERED_A_X2, 0xAB, 0xCD) == (uint16_t)0x5F34);
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_B_X1, 0xAB, 0xCD) == (uint16_t)0xFF34);
  REQUIRE(dac.write(MCP4::BUFFERED_B_X2, 0xAB, 0xCD) == (uint16_t)0xDF34);
}
