...
TEST_CASE("MCP4::write(config, value)", "[func]") {
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_X1, 0xABCD) == 0x7F34);
  REQUIRE(dac.write(MCP4::BUFFERED_X2, 0xABCD) == 0x5F34);
}
...
TEST_CASE("MCP4::write(config, valueUpper, valueLower)", "[func]") {
  ...
  REQUIRE(dac.write(MCP4::BUFFERED_X1, 0xAB, 0xCD) == 0x7F34);
  REQUIRE(dac.write(MCP4::BUFFERED_X2, 0xAB, 0xCD) == 0x5F34);
}
